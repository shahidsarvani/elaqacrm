  ...
  <div class="page-content"> 
    ...
    <div class="content-wrapper"> 
      ...
      <div class="content">   
        ...
        <input type="hidden" name="add_new_link" id="add_new_link" value="<?php echo site_url('portals/add'); ?>">
    ...
    <div class="panel panel-flat">
        ...
        <form name="datas_list_forms" id="datas_list_forms" action="<?php echo site_url('portals/trash_multiple'); ?>" method="post">
        <div id="dyns_list">   
        	...
        	<?php  
				...
				if(isset($records) && count($records)>0){
					foreach($records as $record){ 
                        ...
                        <td class="text-center"><a href="<?= $prtl_properties_url; ?>" target="_blank"> <strong>
                          <?php echo $this->portals_model->count_portal_assigned_properties_nums($record->id); ?>
                        </strong></a></td>
