...
$add_res_nums =  $this->general_model->check_controller_method_permission_access('No_of_bedrooms','add',$this->dbs_user_role_id,'1'); 
				
$update_res_nums =  $this->general_model->check_controller_method_permission_access('No_of_bedrooms','update',$this->dbs_user_role_id,'1');   

$trash_res_nums =  $this->general_model->check_controller_method_permission_access('No_of_bedrooms','trash',$this->dbs_user_role_id,'1'); 
  ...
  <div class="page-content"> 
    ...
    <div class="content-wrapper"> 
      ...
      <div class="content">   
        ...
        <input type="hidden" name="add_new_link" id="add_new_link" value="<?php echo site_url('no_of_bedrooms/add'); ?>">
    ...
    <div class="panel panel-flat">
        ...
        <form name="datas_list_forms" id="datas_list_forms" action="<?php echo site_url('no_of_bedrooms/trash_multiple'); ?>" method="post">
        <div id="dyns_list">   
			...
			<?php  
				...
				if(isset($records) && count($records)>0){
					foreach($records as $record){ 
						$operate_url = 'no_of_bedrooms/update/'.$record->id;
						$operate_url = site_url($operate_url);
						
						$trash_url = 'no_of_bedrooms/trash_aj/'.$record->id;
                        ...
                        <td class="<?php echo ($sr%2==0)?'gradeX':'gradeC'; ?>"><?= stripslashes($record->title); ?></td>
