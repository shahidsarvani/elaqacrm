...
<?php 
	$this->load->view('widgets/meta_tags');  
 	...
 	$add_res_nums =  $this->general_model->check_controller_method_permission_access('Contacts','add',$this->dbs_role_id,'1');
	
	$view_res_nums =  $this->general_model->check_controller_method_permission_access('Contacts','view',$this->dbs_role_id,'1'); 
	  
	$update_res_nums =  $this->general_model->check_controller_method_permission_access('Contacts','update',$this->dbs_role_id,'1');   
	
	$trash_res_nums =  $this->general_model->check_controller_method_permission_access('Contacts','trash',$this->dbs_role_id,'1'); ?>
</head>
  ...
  <div class="page-content"> 
    ...
    <div class="content-wrapper"> 
      ...
      <div class="panel-body">   
		...
		<input type="hidden" name="add_new_link" id="add_new_link" value="<?php echo site_url('contacts/add'); ?>">
		<input type="hidden" name="cstm_frm_name" id="cstm_frm_name" value="datas_list_forms">
		
		<form name="datas_list_forms" id="datas_list_forms" action="<?php echo site_url('contacts/trash_multiple'); ?>" method="post">
        <div class="row">
            <div class="col-md-12"> 
            	...
            	<div class="form-group mb-md">   
                  ...
                  <div class="col-md-3 pull-right"> 
                    ...
                    <?php } if($add_res_nums>0){ ?> 
                         	<a class="dt-button btn border-slate text-slate-800 btn-flat mrglft5" tabindex="0" aria-controls="DataTables_Table_1" href="<?= site_url('contacts/add'); ?>"><span><i class="glyphicon glyphicon-plus position-left"></i>New</span></a>
                    <?php }
                ...
                <?php  
                    ...
                    if(isset($records) && count($records)>0){
                        foreach($records as $record){ 
                            $operate_url = 'contacts/update/'.$record->id;
                            $operate_url = site_url($operate_url); 
							
							$trash_url = 'contacts/trash_aj/'.$record->id;
