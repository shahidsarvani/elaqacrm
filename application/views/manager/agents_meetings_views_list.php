  ...
  <div class="page-content"> 
    ...
    <div class="content-wrapper"> 
      ...
      <div class="content"> 
		...
		<?php } ?> 
        <script>
        	function operate_agents_meetings_views_list(){  	  
				$(document).ready(function(){ 
					...
					$.ajax({
						method: "POST",
						url: "<?php echo site_url('/manager/agents_meetings_views_list2/'); ?>",
        ...
        <div class="row" style="margin-bottom:8px;">
            <div class="col-md-12"> 
            	...
            	<div class="form-group mb-md">   
                  <div class="col-md-1">    
                  <select name="per_page" id="per_page" class="form-control input-sm select2" onChange="operate_agents_meetings_views_list();">
                  ...
                  <div class="col-md-3">  
                  <input name="q_val" id="q_val" onKeyUp="operate_agents_meetings_views_list();" placeholder="Search..." type="text" class="form-control input-sm mb-md">   
            	  </div> 
                  <div class="col-md-3">   
                  </div>    
              ...
              <tbody id="dyns_list">
                <?php  
                    ...
                    if(isset($records) && count($records)>0){
                       ...
                       <tr>
                       <td colspan="5">
                       <div style="float:left;">  <select name="per_page" id="per_page" class="form-control input-sm select2" onChange="operate_agents_meetings_views_list();">
                          <option value="25"> Pages</option>
                          <option value="25"> 25 </option>
                          <option value="50"> 50 </option>
                          <option value="100"> 100 </option> 
