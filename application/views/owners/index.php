        ...
        <div class="row">
            <div class="col-md-12"> 
            	...
            	<div class="form-group mb-md">   
                  <div class="col-md-1">    
                  <select name="per_page" id="per_page" class="form-control input-sm mb-md  select" onChange="operate_owners_list();">
                  ...
                  <div class="col-md-3">  
                  <input name="s_val" id="s_val" onKeyUp="operate_owners_list();" placeholder="Search..." type="text" class="form-control input-sm mb-md">   
            	  </div> 
                  <div class="col-md-3">   
                  </div>    
