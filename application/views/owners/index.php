...
<?php 
	...
	$view_res_nums =  $this->general_model->check_controller_method_permission_access('Owners','view',$this->dbs_role_id,'1'); 
...
<div class="page-container"> 
  ...
  <div class="page-content"> 
        ...
        <script>
        	function operate_owners_list(){  	  
				$(document).ready(function(){ 
					...
					$.ajax({
						method: "POST",
						url: "<?php echo site_url('/owners/index2/'); ?>",
   ...
   <!--  <form name="datas_form" id="datas_form" action="" method="post">-->
    ...
    <input type="hidden" name="add_new_link" id="add_new_link" value="<?php echo site_url('owners/add'); ?>">
    <input type="hidden" name="cstm_frm_name" id="cstm_frm_name" value="datas_list_forms">
    
    <form name="datas_list_forms" id="datas_list_forms" action="<?php echo site_url('owners/trash_multiple'); ?>" method="post">  
        ...
        <div class="row">
            <div class="col-md-12"> 
            	...
            	<div class="form-group mb-md">   
                  <div class="col-md-1">    
                  <select name="per_page" id="per_page" class="form-control input-sm select2" onChange="operate_owners_list();">
                  ...
                  <div class="col-md-3">  
                  <input name="q_val" id="q_val" onKeyUp="operate_owners_list();" placeholder="Search..." type="text" class="form-control input-sm mb-md">   
            	  </div> 
                  <div class="col-md-3">   
                  </div>    
                  ...
                  <div class="col-md-3 pull-right"> 
                    ...
                    <?php } if($add_res_nums>0){ ?> 
                         	<a class="dt-button btn border-slate text-slate-800 btn-flat mrglft5" tabindex="0" aria-controls="DataTables_Table_1" href="<?= site_url('owners/add'); ?>"><span><i class="glyphicon glyphicon-plus position-left"></i>New</span></a>
                    <?php }
              ...
              <tbody id="dyns_list"> 
                <?php  
                    ...
                    if(isset($records) && count($records)>0){
                       ...
                       <tr>
                       <td colspan="8">
                       <div style="float:left;">  <select name="per_page" id="per_page" class="form-control input-sm select2" onChange="operate_owners_list();">
                          <option value="25"> Pages</option>
                          <option value="25"> 25 </option>
                          <option value="50"> 50 </option>
                          <option value="100"> 100 </option> 
