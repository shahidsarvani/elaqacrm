...
<!--<script type="text/javascript" src="<?= asset_url(); ?>js/plugins/notifications/jgrowl.min.js"></script>
...
<script type="text/javascript" src="<?= asset_url(); ?>js/plugins/pickers/anytime.min.js"></script>
...
<script type="text/javascript" src="<?= asset_url(); ?>js/plugins/pickers/pickadate/legacy.js"></script> 
<script type="text/javascript" src="<?= asset_url(); ?>js/pages/picker_date.js"></script>-->
            ...
            <div class="row">
                <div class="col-md-12"> 
                    ...
                    <div class="col-md-2 pull-right"> 
                   		<div class="dt-buttons"> <a class="dt-button btn border-slate text-slate-800 btn-flat mrglft5" tabindex="0" aria-controls="DataTables_Table_1" href="<?= site_url('tasks/operate_task_to_do'); ?>"><span><i class="glyphicon glyphicon-plus position-left"></i>New</span></a></div>
		 ...
		 <style>
            ...
            <table class="table table-bordered table-striped table-hover">
              <thead>
                <tr>
                  <th width="7%">#</th>
                  <th class="text-center">Property Ref No.</th>
                  <th class="text-center">Lead Ref No.</th>
                  <th class="text-center">Task Detail</th>
                  <th class="text-center">Assigned To </th>
                  <th class="text-center">Due Date </th>
                  <th class="text-center">Due Timing</th>
                  <th class="text-center">Task Added</th>
