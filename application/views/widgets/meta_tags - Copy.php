...
<title>ilaqa CRM Admin Panel</title>
<meta name="keywords" content="ilaqa CRM Admin Panel" />
<meta name="description" content="ilaqa CRM Admin Panel">
<meta name="author" content="ilaqa CRM Admin Panel">
...
<?php //if(isset($this->select2) && $this->select2==1){ ?>
...
<?php //if(isset($this->multiselects) && $this->multiselects==1){ ?>
<script type="text/javascript" src="<?= asset_url(); ?>js/pages/form_multiselect.js"></script>
<?php //} 

//if(isset($this->formlayout) && $this->formlayout==1){ ?>
...
<?php //if(isset($this->apps) && $this->apps==1){ ?>
