...
$add_res_nums =  $this->general_model->check_controller_method_permission_access('Categories','add',$this->dbs_user_role_id,'1'); 
				
$update_res_nums =  $this->general_model->check_controller_method_permission_access('Categories','update',$this->dbs_user_role_id,'1');   

$trash_res_nums =  $this->general_model->check_controller_method_permission_access('Categories','trash',$this->dbs_user_role_id,'1'); 
  ...
  <div class="page-content"> 
    ...
    <div class="content-wrapper"> 
      ...
      <div class="content">   
        ...
        <input type="hidden" name="add_new_link" id="add_new_link" value="<?php echo site_url('categories/add'); ?>">
    ...
    <div class="panel panel-flat">
        ...
        <form name="datas_list_forms" id="datas_list_forms" action="<?php echo site_url('categories/trash_multiple'); ?>" method="post">
        <div id="dyns_list">   
        <table class="table datatable-button-init-custom">
             <thead>
              <tr>
                <th width="5%">#</th>
                <th width="20%">Name</th>
                <th width="10%" class="text-center"> Property Type</th>
                <th width="10%" class="text-center">Order </th>
                <th width="15%" class="text-center">Show in Sale</th>
                <th width="15%" class="text-center">Show in Rent</th>
			...
			<?php  
				...
				if(isset($records) && count($records)>0){
					foreach($records as $record){ 
						$operate_url = 'categories/update/'.$record->id;
						$operate_url = site_url($operate_url);
						
						$trash_url = 'categories/trash_aj/'.$record->id;
                        ...
                        <td class="text-center"><?php  
							if($record->show_in_sale==1){
								echo 'Yes';
							}else{
								echo 'No';
							} ?></td>
                        <td class="text-center"><?php  
							if($record->show_in_rent==1){
								echo 'Yes';
							}else{
								echo 'No';
							} ?></td>
