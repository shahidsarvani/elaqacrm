      ...
      <div class="panel-body">
       <?php 
        ...
        if(isset($args1) && $args1>0){
            $form_act = "property_features/update/".$args1;
        } ?>
        <form name="datas_form" id="datas_form" method="post" action="<?php echo site_url($form_act); ?>" class="form-horizontal">
            ...
            <div class="form-group">
              ...
              <div class="col-md-6">
                <input name="short_tag" id="short_tag" type="text" class="form-control" value="<?php echo (isset($record)) ? stripslashes($record->short_tag): set_value('short_tag'); ?>" data-error="#short_tag1">
            ...
            <div class="form-group mb-md">
              ...
              <div class="col-md-6">
				...
				<?php   
                    ...
                    }else if(isset($record) && strlen($record->amenities_types)>0){
                        $db_amenities_types = $record->amenities_types;
                        $db_amenities_types_arrs = explode(',',$db_amenities_types); 
                    } 
