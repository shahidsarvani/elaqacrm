  ...
  <div class="page-content"> 
    ...
    <div class="content-wrapper"> 
      ...
      <div class="content">   
        ...
        <input type="hidden" name="add_new_link" id="add_new_link" value="<?php echo site_url('property_features/add'); ?>">
    ...
    <div class="panel panel-flat">
        ...
        <form name="datas_list_forms" id="datas_list_forms" action="<?php echo site_url('property_features/trash_multiple'); ?>" method="post">
        <div id="dyns_list">   
