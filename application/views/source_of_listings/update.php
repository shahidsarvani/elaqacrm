    ...
    <div class="panel panel-flat">
      ...
      <?php 
		...
		if(isset($args1) && $args1>0){
			$form_act = "source_of_listings/update/".$args1;
		}  ?> 
	  <form name="datas_form" id="datas_form" method="post" action="<?php echo site_url($form_act); ?>" class="form-horizontal">
		...
		<div class="form-group">
		  ...
		  <?php 
			...
			<span id="sort_order1" class="text-danger" generated="true"><?php echo form_error('title'); ?></span>
		  </div> 
		</div>  
      ...
      <?php } ?>
          &nbsp;
          <button type="button" class="btn border-slate text-slate-800 btn-flat" onClick="window.location='<?php echo site_url('source_of_listings/index'); ?>';"><i class="glyphicon glyphicon-chevron-left position-left"></i>Cancel</button> 
