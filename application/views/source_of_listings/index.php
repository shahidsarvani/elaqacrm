...
$add_res_nums =  $this->general_model->check_controller_method_permission_access('Source_of_listings','add',$this->dbs_user_role_id,'1'); 	
		
$update_res_nums =  $this->general_model->check_controller_method_permission_access('Source_of_listings','update',$this->dbs_user_role_id,'1');   

$trash_res_nums =  $this->general_model->check_controller_method_permission_access('Source_of_listings','trash',$this->dbs_user_role_id,'1');
  ...
  <div class="page-content"> 
    ...
    <div class="content-wrapper"> 
      ...
      <div class="content">   
        ...
        <input type="hidden" name="add_new_link" id="add_new_link" value="<?php echo site_url('source_of_listings/add'); ?>">
    ...
    <div class="panel panel-flat">
        ...
        <form name="datas_list_forms" id="datas_list_forms" action="<?php echo site_url('source_of_listings/trash_multiple'); ?>" method="post">
        <div id="dyns_list">   
			...
			<?php 
				...
				if(isset($records) && count($records)>0){
					foreach($records as $record){ 
						$operate_url = 'source_of_listings/update/'.$record->id;
						$operate_url = site_url($operate_url);
						
						$trash_url = 'source_of_listings/trash_aj/'.$record->id;
                        ...
                        <td class="table datatable-colvis-state"><?= stripslashes($record->title); ?></td>
