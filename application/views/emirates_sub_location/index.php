...
$add_res_nums =  $this->general_model->check_controller_method_permission_access('Emirates_sub_location','add',$this->dbs_user_role_id,'1'); 
				
$update_res_nums =  $this->general_model->check_controller_method_permission_access('Emirates_sub_location','update',$this->dbs_user_role_id,'1');   

$trash_res_nums =  $this->general_model->check_controller_method_permission_access('Emirates_sub_location','trash',$this->dbs_user_role_id,'1'); 
  ...
  <div class="page-content"> 
    ...
    <div class="content-wrapper"> 
      ...
      <div class="content">   
        ...
        <input type="hidden" name="add_new_link" id="add_new_link" value="<?php echo site_url('emirates_sub_location/add'); ?>">
    ...
    <form name="datas_list_forms" id="datas_list_forms" action="<?php echo site_url('emirates_sub_location/trash_multiple'); ?>" method="post">
    <div id="dyns_list">  
       ...
       <table class="table datatable-button-init-custom">
        <thead>
          <tr>
            <th width="6%">#</th>
            <th width="25%">Sub Location Name</th>
            <th width="18%" class="text-center">Location Name</th>
            <th width="18%" class="text-center">Emirate</th>
		...
		<?php  
            ...
            if(isset($records) && count($records)>0){
                foreach($records as $record){ 
                    $operate_url = 'emirates_sub_location/update/'.$record->id;
                    $operate_url = site_url($operate_url);
                     
                    $trash_url = site_url('emirates_sub_location/trash_aj/'); ?>
                    <tr>
                    <td>
                    <div class="checkbox">
                    ...
                    <td class="text-center"><?= stripslashes($record->location_name); ?></td>
