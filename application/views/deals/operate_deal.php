					   ...
					   <?php 
						 ...
						 <div class="form-group">
						  ...
						  <div class="col-lg-6"> 
							...
							<input name="est_deal_date" id="est_deal_date" type="text" class="form-control picks-date" value="<?php echo $est_deal_date; ?>" style="text-align:center;">
							...
							<input name="act_deal_date" id="act_deal_date" type="text" class="form-control picks-date" value="<?php echo $act_deal_date; ?>" style="text-align:center;">
