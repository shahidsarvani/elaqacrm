...
if(isset($_POST['emirate_location_id']) && $_POST['emirate_location_id']==$emirate_sub_location_arr->id){
   ...
   <?php } ?>	      
    ...
    <div class="panel panel-flat">
		...
		<input style="display:none" type="hidden" name="add_new_link" id="add_new_link" value="<?php echo site_url('deals/operate_deal/1'); ?>">
                ...
                <div class="form-group mb-md">   
                  ...
                  <div class="col-md-10 pull-right"> 
                    ...
                    <?php } if($add_res_nums>0){ ?> 
                         	<a class="dt-button btn border-slate text-slate-800 btn-flat mrglft5" tabindex="0" aria-controls="DataTables_Table_1" href="<?= site_url('deals/operate_deal/1/'); ?>"><span><i class="glyphicon glyphicon-plus position-left"></i>New</span></a>
                    <?php }
