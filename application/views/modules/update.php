        ...
        <div class="col-md-6">
          <select name="parent_id" id="parent_id" class="form-control select2"  data-error="#parent_id1">
            ...
            if(isset($par_modules_arrs) && count($par_modules_arrs)>0){
               ...
               <span id="parent_id1" class="text-danger"><?php echo form_error('parent_id'); ?></span>
              </div>
          </div>
          ...
          <div class="form-group">
			...
			<div class="col-md-6">
              ...
              <span id="icon_name1" class="text-danger"><?php echo form_error('icon_name'); ?></span> 
               </div>
		  </div>
          ...
          <div class="form-group">
            ...
            <div class="col-md-6">
                  ...
                  <span id="controller_name1" class="text-danger"><?php echo form_error('controller_name'); ?></span> 
              </div>  
          </div>
		   
		  <div class="form-group">
			<label class="control-label col-md-2" for="method_name"> Module Name <span class="reds"> </span></label>
			<div class="col-md-6">
			  <input name="method_name" id="method_name" type="text" class="form-control" value="<?php echo (isset($record)) ? stripslashes($record->method_name): set_value('method_name'); ?>" data-error="#method_name1"> 
              <span id="method_name1" class="text-danger"><?php echo form_error('method_name'); ?></span> 
            </div>
		  </div>    
