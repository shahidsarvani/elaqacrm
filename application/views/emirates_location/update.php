            ...
            <div class="panel panel-flat">
              ...
              <div class="panel-body">
				...
				if(isset($args1) && $args1>0){
					$form_act = "emirates_location/update/".$args1;
				}  ?>
                <form name="datas_form" id="datas_form" method="post" action="<?php echo site_url($form_act); ?>" class="form-horizontal">
                  <div class="form-group">
                    ...
                    <div class="col-md-6">
                      <input name="name" id="name" type="text" class="form-control" value="<?php echo (isset($record)) ? stripslashes($record->name): set_value('name'); ?>" data-error="#loc_name">
                    ...
                    <?php  
                        if(isset($emirate_arrs) && count($emirate_arrs)>0){
                            foreach($emirate_arrs as $emirate_arr){
                                ...
                                }else if(isset($record) && $record->emirate_id==$emirate_arr->id){
                                    $sel_1 = 'selected="selected"';
                                } ?>
			  ...
			  <div class="form-group">
				...
				<div class="col-md-6">
					<textarea name="sale_text" id="sale_text" class="form-control" rows="5" data-error="#sale_text1"><?php echo (isset($record)) ? stripslashes($record->sale_text): set_value('sale_text'); ?></textarea> 
			  ...
			  <div class="form-group">
				...
				<div class="col-md-6">
					<textarea name="rent_text" id="rent_text" class="form-control" rows="5" data-error="#rent_text1"><?php echo (isset($record)) ? stripslashes($record->rent_text): set_value('rent_text'); ?></textarea> 
