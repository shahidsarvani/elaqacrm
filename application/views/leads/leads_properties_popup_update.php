  ...
  <section class="panel">
    ...
    <div class="container">
        ...
        <div class="col-lg-6">
          ...
          <div class="form-group">
            ...
            <div class="col-md-8">  
             <?php  
			$operate_url = 'properties/leads_properties_popup_update_act/';
			$operate_url = site_url($operate_url); ?>
            <input type="button" name="adds_contacts" id="adds_contacts" class="btn btn-primary" value="Update requirement" onclick="operate_updates_lead_property('<?php echo $operate_url; ?>','fetch_contacts_popup_add_list');" /> 
            </div>
          </div>
        </div>
        <div class="col-lg-6"> 
         ...
         <input name="paras2" id="paras2" type="hidden" value="<?php echo $paras2; ?>">
	...
	function sels_chk_box_vals2(nw_owner_id_val){
		if(nw_owner_id_val >0){
			var paras2_val = document.getElementById('paras2').value; 
			paras2_val = paras2_val.trim();  
			 
			window.parent.dyns_properties(nw_owner_id_val,paras2_val);  
		}
	} 
	  
	var params;
	var objdiv;  
	function operate_updates_lead_property(url,dis){    
		objdiv=dis;
		...
		if(valids==false){ 
			...
			url = url+"?category_id_val="+category_id_val+"&no_of_beds_id_val="+no_of_beds_id_val+"&emirate_id_val="+emirate_id_val+"&location_id_val="+location_id_val+"&sub_location_id_val="+sub_location_id_val+"&types="+types+"&plot_area="+plot_area+"&price="+price+"&paras1="+paras1_val+"&paras2="+paras2_val+"&rands_val="+rands_val; 
