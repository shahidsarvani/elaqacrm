                  ...
                  <div class="row">
                    <div class="col-lg-6">
                      ...
                      <div class="form-group">
                        ...
                        <div class="col-md-8">
							<span id="fetch_new_contacts">  
							<select name="contact_id" id="contact_id" class="form-control" data-error="#contact_id1">
						  ...
						  <span id="fetch_contacts_info"> </span>
			...
			function clickeds(sels_vals) { //alert( sels_vals );
				$(document).ready(function(){
					<?php 
						...
						//alert( "<?php echo $tmp_owr_pth1; ?>" + sels_vals );
