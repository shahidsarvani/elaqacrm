                      ...
                      <div class="form-group">
                        ...
                        <div class="col-md-8">
                          <div id="fetch_new_contacts">
                            <input type="text" name="contact_id" id="contact_id" class="form-control select2" value="<?php echo (isset($record) && $record->contact_id >0) ? $record->contact_id:'0'; ?>" onChange="operate_contact_info(this.value);">
