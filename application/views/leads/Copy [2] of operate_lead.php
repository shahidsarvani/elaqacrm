  ...
  <div class="page-content">
                    ...
                    <div class="col-lg-6">
                      ...
                      <div class="form-group">
                        ...
                        <div class="col-md-8">
							...
							<select name="contact_id" id="contact_id" class="form-control select2" data-error="#assigned_to_id1">
							<option value="">Select Contact</option>
							<?php  
								if(isset($contact_arrs)){
									foreach($contact_arrs as $contact_arr){
									$sel_1 = '';
									if(isset($_POST['assigned_to_id']) && $_POST['assigned_to_id']==$contact_arr->id){
										$sel_1 = 'selected="selected"';
									}else if(isset($record) && $record->assigned_to_id==$contact_arr->id){
										$sel_1 = 'selected="selected"';
									} ?>
                          ...
                          <div id="fetch_new_contacts"> 
                            <input type="text" name="contact_id" id="contact_id" class="form-control" value="<?php echo (isset($record) && $record->contact_id >0) ? $record->contact_id:'0'; ?>" onChange="operate_contact_info(this.value);">  
                          ...
                          <?php
							$cnt_popup_url = 'contacts/contacts_popup_list';
							$cnt_popup_url = site_url($cnt_popup_url);  
							if($chk_add_contact_permission==1){ ?>  
								<a data-toggle="modal" data-target="#modal_remote_contacts"><i class="glyphicon glyphicon-plus position-left"></i> Add Contacts</a>
                          ...
                          <div class="col-md-8">
                            <div class="panel-group" id="accordionSuccess">
                              <div class="panel panel-accordion panel-accordion-default">
                                <div class="panel-heading" style="height:35px; clear:both;"> <a class="accordion-toggle collapsed fa fa-caret-down" data-toggle="collapse" data-parent="#accordionSuccess" href="#collapseSuccessOne" aria-expanded="false" id="property_title_1" style="display:inline; float:left; padding:0px; margin:10px;"> &nbsp; <?php echo $pp_ref_no_title_1; ?> </a> <a style=" <?php echo ($sel_property_id_1 >0) ? 'display:inline;' : 'display:none;'; ?> float:right; padding:0px; margin:8px 4px 8px 8px;" href="javascript:operate_remove_property('1');" id="propery_remove_link_txt_1"> <i class="fa fa-minus"> </i> </a>
                                  <?php  
							if($sel_property_id_1 >0){ 
								...
								$lead_prop_popup_url_1 = site_url($lead_prop_popup_url_1);    ?>
                                  <a style="display:inline; float:right; padding:0px; margin:8px 4px 8px 8px;" class="simple-ajax-modal" href="<?php echo $lead_prop_popup_url_1; ?>" id="propery_link_txt_1"> <i class="fa fa-plus"> </i> </a> </div>
					...
					if(isset($cates_arr2) && count($cates_arr2) >0){
						$pp_cate_name_2 = stripslashes($cates_arr2->name);
                          ...
                          <div class="col-md-8">
                            <div class="panel-group" id="accordionSuccess">
                              <div class="panel panel-accordion panel-accordion-default">
                                <div class="panel-heading" style="height:35px; clear:both;"> <a class="accordion-toggle collapsed fa fa-caret-down" data-toggle="collapse" data-parent="#accordionSuccess" href="#collapseSuccess2" aria-expanded="false" id="property_title_2" style="display:inline; float:left; padding:0px; margin:10px;"> &nbsp; <?php echo $pp_ref_no_title_2; ?> </a> <a style=" <?php echo ($sel_property_id_2 >0) ? 'display:inline;' : 'display:none;'; ?> float:right; padding:0px; margin:8px 4px 8px 8px;" href="javascript:operate_remove_property('2');" id="propery_remove_link_txt_2"> <i class="fa fa-minus"> </i> </a>
                                  <?php  
							if($sel_property_id_2 >0){ 
							...
							$lead_prop_popup_url_2 = site_url($lead_prop_popup_url_2);    ?>
                                  <a style="display:inline; float:right; padding:0px; margin:8px 4px 8px 8px;" class="simple-ajax-modal" href="<?php echo $lead_prop_popup_url_2; ?>" id="propery_link_txt_2"> <i class="fa fa-plus"> </i> </a> </div>
					...
					if(isset($cates_arr3) && count($cates_arr3) >0){
						$pp_cate_name_3 = stripslashes($cates_arr3->name);
                          ...
                          <div class="col-md-8">
                            <div class="panel-group" id="accordionSuccess">
                              <div class="panel panel-accordion panel-accordion-default">
                                <div class="panel-heading" style="height:35px; clear:both;"> <a class="accordion-toggle collapsed fa fa-caret-down" data-toggle="collapse" data-parent="#accordionSuccess" href="#collapseSuccess3" aria-expanded="false" id="property_title_3" style="display:inline; float:left; padding:0px; margin:10px;"> &nbsp; <?php echo $pp_ref_no_title_3; ?> </a> <a style=" <?php echo ($sel_property_id_3 >0) ? 'display:inline;' : 'display:none;'; ?> float:right; padding:0px; margin:8px 4px 8px 8px;" href="javascript:operate_remove_property('3');" id="propery_remove_link_txt_3"> <i class="fa fa-minus"> </i> </a>
                                  <?php  
							if($sel_property_id_3 >0){ 
							...
							$lead_prop_popup_url_3 = site_url($lead_prop_popup_url_3);    ?>
                                  <a style="display:inline; float:right; padding:0px; margin:8px 4px 8px 8px;" class="simple-ajax-modal" href="<?php echo $lead_prop_popup_url_3; ?>" id="propery_link_txt_3"> <i class="fa fa-plus"> </i> </a> </div>
				...
				if(isset($cates_arr3) && count($cates_arr3) >0){
					$pp_cate_name_4 = stripslashes($cates_arr3->name);
                          ...
                          <div class="col-md-8">
                            <div class="panel-group" id="accordionSuccess">
                              <div class="panel panel-accordion panel-accordion-default">
                                <div class="panel-heading" style="height:35px; clear:both;"> <a class="accordion-toggle collapsed fa fa-caret-down" data-toggle="collapse" data-parent="#accordionSuccess" href="#collapseSuccess4" aria-expanded="false" id="property_title_4" style="display:inline; float:left; padding:0px; margin:10px;"> &nbsp; <?php echo $pp_ref_no_title_4; ?> </a> <a style=" <?php echo ($sel_property_id_4 >0) ? 'display:inline;' : 'display:none;'; ?> float:right; padding:0px; margin:8px 4px 8px 8px;" href="javascript:operate_remove_property('4');" id="propery_remove_link_txt_4"> <i class="fa fa-minus"> </i> </a>
                                  <?php  
							if($sel_property_id_4 >0){ 
						...
						$lead_prop_popup_url_4 = site_url($lead_prop_popup_url_4);    ?>
                                  <a style="display:inline; float:right; padding:0px; margin:8px 4px 8px 8px;" class="simple-ajax-modal" href="<?php echo $lead_prop_popup_url_4; ?>" id="propery_link_txt_4"> <i class="fa fa-plus"> </i> </a> </div>
	...
	<?php 
		...
		function operate_contact_info(sels_vals){
			...
			$(document).ready(function(){   
				<?php  
					$tmp_ownr_pth = '/contacts/get_jsoned_contacts_list';
					...
					$tmp_owr_pth = '/contacts/get_jsoned_contact_by_id/'.$tmp_sel_contact_id;
			...
			function clickeds(sels_vals) { alert( sels_vals );
				$(document).ready(function(){
					<?php 
						$tmp_ownr_pth1 = '/contacts/get_jsoned_contacts_list';
						$tmp_ownr_pth1 = site_url($tmp_ownr_pth1);	
						  
						$tmp_owr_pth1 = '/contacts/get_jsoned_contact_by_id/';
						$tmp_owr_pth1 = site_url($tmp_owr_pth1);	?>  
						//alert( "<?php echo $tmp_ownr_pth1; ?>" );
						//alert( "<?php echo $tmp_owr_pth1; ?>" );
			...
			<?php 
			$get_property_info_url = 'leads/get_lead_property_popup_detail/';
			...
			function dyns_properties(sels_vals,paras1_val) {   
				$(document).ready(function(){     
					 ...
					 $.ajax({
					   ...
					   <?php  
							$lead_prop_update_popup_url_1 = "leads/leads_properties_popup_update/";
							$lead_prop_update_popup_url_1 = site_url($lead_prop_update_popup_url_1);
							 ?>   
			...
			function operate_property_brief_popup(paras1_val,paras2_val) {
				$(document).ready(function(){
					...
					if(paras1_val >0){
						...
						<?php    	
							$get_lead_property_briefs = 'leads/get_lead_property_brief/';
